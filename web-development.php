<?php
$title = "Professional Web Development Services | Shreenandik IT Solutions";
$desc = "Enhance your online presence with professional web development services from Shreenandik. Discover how our experienced team can create custom websites that are visually stunning, user-friendly, and optimized for performance, helping you achieve your business goals.";
include_once './public/lib/common/header.php';
?>
<section class="page-header ">
    <div class="web-development headerTop">
    </div>
</section>
    ...
    <div class="container">
        <div class="case-header text-center  wow animate__animated animate__fadeInUp row">
            <div class="col-xl-10 offset-xl-1">
                <h2 class="title3 black2 animation_title" id="title">Web Development</h2>
                <p class="Atext pt-5">
...
<section class="nandik-sec nandik-bg web-development-timeline highlight_bg">
    <div class="container">
        ...
        <div class="row row-handle">
            ...
            <div class="col-lg-6">
                <div class="img-content">
                    <img src="./public/assets/images/web/web-app.png" alt="web">
                </div>
            </div>
...
<section class="nandik-sec nandik-bg faq-section faq_bg">
    <div class="container">
        <div class="case-header text-center  mb-5 wow animate__animated animate__fadeInUp row">
            <div class="col-xl-10 offset-xl-1">
                <h2 class="title3 black2">FAQ's about  Web Development</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-10 offset-xl-1">
                <div class="faq-content">
                    <div class="accordion">
                        <div class="accordion-item">
                            <button id="accordion-button-1" aria-expanded="false"><span class="accordion-title">What is web development?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p> Web development refers to the process of creating websites or web applications for the Internet. It involves various tasks such as web design, web content development, client-side/server-side scripting, and network security configuration.</p>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <button id="accordion-button-2" aria-expanded="false"><span class="accordion-title">Why is web development important for businesses?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p> Web development is essential for businesses to establish their online presence and reach a wider audience. A well-designed and functional website can help businesses attract customers, showcase their products or services, generate leads, and drive sales.</p>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What are the different types of web development?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p>There are three main types of web development: front-end development, back-end development, and full-stack development. Front-end development focuses on the user interface and user experience of a website, while back-end development involves server-side programming and database management. Full-stack development encompasses both front-end and back-end development.</p>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <button id="accordion-button-4" aria-expanded="false"><span class="accordion-title">What technologies are commonly used in web development?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p>Common technologies used in web development include HTML, CSS, and JavaScript for front-end development, and languages such as PHP, Python, Ruby, and Java for back-end development. Frameworks like React, Angular, and Vue.js are also popular for building dynamic and interactive web applications.</p>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <button id="accordion-button-5" aria-expanded="false"><span class="accordion-title">How long does it take to develop a website?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p>The time required to develop a website depends on various factors such as its complexity, features, functionality, design requirements, and the development approach (e.g., custom development vs. using pre-built templates). Simple websites can be developed in a few weeks, while more complex websites may take several months to complete.</p>
                            </div>
                        </div>
                    </div>
                </div>
