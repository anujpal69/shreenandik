<?php
$title = "Business Automation Solutions | Shreenandik IT Services";
$desc = "Streamline your operations and increase efficiency with Shreenandik's business automation solutions. Discover how our tailored automation services can optimize your workflows, reduce manual tasks, and drive productivity, allowing you to focus on strategic growth initiatives.";
include_once './public/lib/common/header.php';
?>
<section class="page-header ">
    <div class="business-automation headerTop">
    </div>
</section>
    ...
    <div class="container">
        <div class="case-header text-center  wow animate__animated animate__fadeInUp row">
            <div class="col-xl-10 offset-xl-1">
                <h2 class="title3 black2 animation_title" id="title">Business Automation Solutions</h2>
                <p class="Atext pt-5">
...
<section class="nandik-sec nandik-bg business_Auto_timeline highlight_bg">
    <div class="container">
        ...
        <div class="row row-handle">
            ...
            <div class="col-lg-6">
                <div class="img-content">
                    <img src="./public/assets/images/busi-auto/busi.png" alt="shreenandik">
                </div>
            </div>
...
<section class="nandik-sec nandik-bg faq-section faq_bg">
    <div class="container">
        <div class="case-header text-center  mb-5 wow animate__animated animate__fadeInUp row">
            <div class="col-xl-10 offset-xl-1">
                <h2 class="title3 black2">FAQ's about Business Automation</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-10 offset-xl-1">
                <div class="faq-content">
                    <div class="accordion">
                        <div class="accordion-item">
                            <button id="accordion-button-1" aria-expanded="false"><span class="accordion-title">What is business automation?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p>Business automation refers to the use of technology to automate repetitive tasks and processes within an organization. This can include tasks such as data entry, document generation, email marketing, and more.</p>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <button id="accordion-button-2" aria-expanded="false"><span class="accordion-title">What are the benefits of implementing business automation?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p>Implementing business automation can lead to increased efficiency, reduced errors, cost savings, improved productivity, faster decision-making, and better allocation of resources. It allows businesses to streamline their operations and focus on more strategic tasks.</p>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What are some examples of business automation tools and software?</span><span class="icon" aria-hidden="true"></span></button>
                            <div class="accordion-content">
                                <p>There are various types of business automation tools and software available, including workflow automation platforms, robotic process automation (RPA) software, customer relationship management (CRM) systems, marketing automation tools, accounting software, and more.</p>
                            </div>
                        </div>
                        <div class="accordion-item">
